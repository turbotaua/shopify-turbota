...
const sourceElementId = 'shopify-block-qikify_upsell_bundle_bundle_offer_ce3U8C';
const sourceElement = document.getElementById(sourceElementId);

// Знаходимо елемент, в який ми хочемо перемістити
const destinationElementId = 'MediaGallery-template--22011184578863__main-product';
...
const moveElement = () => {
  if (sourceElement && destinationElement) {
    ...
    console.error('Не вдалося знайти елементи за вказаними id');
  }
};
...
fromDateElement.innerHTML = `<span style="margin-right: 3px;">${todayFormatted}</span><span style="margin-right: 3px;">-</span><span>${futureDateFormatted}</span>`;
...
// Add scroll buttons for the timeline
document.addEventListener('DOMContentLoaded', () => {
...
<path d="M5.30002 1L0.800018 5.5L5.30002 10" stroke="var(--color-accent)" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
  ...
  rightBtn.innerHTML = `
    <svg width="15" height="11" viewBox="0 0 15 11" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M5.29995 1L10.8 5.5L5.29995 10" stroke="var(--color-accent)" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
    </svg>
  `;

  scrollContainer.parentElement.insertBefore(leftBtn, scrollContainer);
...
// Click on the buy now button and rename
document.getElementById('shopify-payment-button__button').addEventListener('click', function() {
